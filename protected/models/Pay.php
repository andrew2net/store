...
class Pay extends CActiveRecord
{
    ...
    const NO_SUCH_TRANSACTION = 1, PENDING_CUSTOMER_INPUT = 2, PENDING_AUTH_RESULT = 3,
        ...
        MID_DISABLED = 10, WAIT_ACCEPT = 11, WAIT_LC = 12, PROCESSING = 13, SUBSCRIBED = 14,
        UNSUBSCRIBED = 15, CASH_WAIT = 16;
    ...
    private static $statuses = array(
        ...
        11 => 'Ожидание проверки магазина',
        12 => 'Ожидается подтверждение доставки ',
        13 => 'Платеж обрабатывается',
        14 => 'Подписка успешно оформлена',
        15 => 'Подписка успешно деактивирована',
        16 => 'Ожидание оплаты счета клиентом в терминале',
    );
