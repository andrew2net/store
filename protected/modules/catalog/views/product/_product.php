...
<div>
    ...
    <div class="inline-blocks">
        <div style="vertical-align: top">
            <?php echo $form->textFieldControlGroup($model, 'remainder_RU', array('span' => 1)); ?>
        </div>
        <?php if (Yii::app()->params['mcurrency']) { ?>
          <div style="vertical-align: top">
              <?php echo $form->textFieldControlGroup($model, 'remainder_KZ', array('span' => 1)); ?>
          </div>
        <?php } ?>

        <div style="vertical-align: top">
            <?php
            echo $form->textFieldControlGroup($model, 'price', array('span' => 2, 'maxlength' => 12
              , 'labelOptions' => array('class' => 'ruble', 'style' => 'display:inline-block;position:relative',)));
            ?>
        </div>
        <?php if (Yii::app()->params['mcurrency']) { ?>
          <div style="vertical-align: top">
...
<div class="inline-blocks clear">
    <?php echo $form->textAreaControlGroup($model, 'description', array('rows' => 6, 'span' => 7, 'style' => 'margin-right:20px')); ?>
    <?php echo $form->textAreaControlGroup($model, 'seo', array('rows' => 6, 'span' => 5)); ?>
</div>
