...
/**
 * This is the model class for table "store_product_feature".
 *
 * The followings are the available columns in table 'store_product_feature':
 * @property string $id
