    ...
    $this->widget('zii.widgets.grid.CGridView', array(
      ...
      'columns' => array(
        ...
        array(
          'name' => 'status_id',
          'type' => 'html',
          'value' => '$data->status_id==4 && $data->payment->type_id!=0 && $data->productSumm>$data->paySumm ? CHtml::link($data->status,'
          . ' Yii::app()->createUrl("pay/order", array("id"=>$data->id))) : $data->status',
        ),
      )
    ));
    ?>
